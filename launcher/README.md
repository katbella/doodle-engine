...
It lives in the `launcher/` folder of the Doodle Engine repository, outside the versioned workspace packages, and is published manually when its dependency range needs widening.
