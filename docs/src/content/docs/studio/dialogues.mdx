...
<ThemeScreenshot src="/images/studio/dialogue-editor.webp" alt="Editing a dialogue in Doodle Studio" />
...
<ThemeScreenshot src="/images/studio/dialogue-nodes.webp" alt="The node list and selected starting node" />

<ThemeScreenshot src="/images/studio/dialogue-node-fields.webp" alt="Speaker, line, voice, and portrait controls for a node" />
...
<ThemeScreenshot src="/images/studio/dialogue-node-header.webp" alt="A dialogue node header with Play from here and Delete node" />
...
<ThemeScreenshot src="/images/studio/dialogue-choice.webp" alt="Editing a dialogue choice and its route" />
...
<ThemeScreenshot src="/images/studio/dialogue-graph.webp" alt="The graph view showing the paths through a dialogue" />
...
<ThemeScreenshot src="/images/studio/condition-builder.webp" alt="Adding a requirement with the condition builder" />
...
<ThemeScreenshot src="/images/studio/effect-media-file.webp" alt="Choosing a sound file in the effect builder" />
...
<ThemeScreenshot src="/images/studio/dialogue-source.webp" alt="A dialogue open in Source mode" />
