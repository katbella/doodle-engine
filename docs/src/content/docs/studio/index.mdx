...
<ThemeScreenshot src="/images/studio/welcome.webp" alt="Doodle Studio welcome screen" />
...
<ThemeScreenshot src="/images/studio/workspace.webp" alt="A project open in the Doodle Studio workspace" />
