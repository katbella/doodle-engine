...
description: Test dialogue branches and game state in Doodle Studio.
---
...
<ThemeScreenshot src="/images/studio/playtest-toolbar.webp" alt="Starting a playtest at a specific dialogue node" />

<ThemeScreenshot src="/images/studio/start-node-picker.webp" alt="Choosing the dialogue and node where the playtest begins" />
...
<ThemeScreenshot src="/images/studio/playtest-choices.webp" alt="Available and hidden choices in the playtester" />
...
<ThemeScreenshot src="/images/studio/playtest-state.webp" alt="Flags, variables, inventory, location, and relationships in the state inspector" />
...
<ThemeScreenshot src="/images/studio/save-test-state.webp" alt="Naming a saved playtest state" />
...
<ThemeScreenshot src="/images/studio/debug-trace.webp" alt="The debug trace for the active playtest" />
...
See [Flags & Variables](/guides/flags-and-variables/) when deciding which variables should appear in the default game interface and which should remain internal.
