...
## Work through validation problems
...
<ThemeScreenshot src="/images/studio/validation-problems.webp" alt="A dialogue problem opened at the matching requirement, with the same message in the Validation panel and Problems dock" />
