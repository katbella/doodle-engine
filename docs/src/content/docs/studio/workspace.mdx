...
Select **Flags & vars** in the top bar to open the project-wide page for these names. Use it to find where a name is set or checked, keep a note about its purpose, and rename known uses. See [Flags & Variables](/studio/flags-and-variables/) for the complete workflow.
