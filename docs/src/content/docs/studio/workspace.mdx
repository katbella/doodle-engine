...
Select **Flags & vars** in the top bar to open the project-wide page for these names. Search and group names, review where they are set and checked, add notes, find likely mistakes, and rename known uses. See [Flags & Variables](/studio/flags-and-variables/) for the complete workflow.
