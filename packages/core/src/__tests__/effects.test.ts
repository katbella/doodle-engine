...
describe('Effect Processors', () => {
  ...
  describe('setVariable', () => {
    it('should set a numeric variable', () => {
      const effect: Effect = { type: 'setVariable', variable: 'gold', value: 250 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should set a string variable', () => {
      const effect: Effect = { type: 'setVariable', variable: 'playerName', value: 'Hero' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('addVariable', () => {
    it('should add to an existing numeric variable', () => {
      const effect: Effect = { type: 'addVariable', variable: 'gold', value: 50 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should subtract from an existing numeric variable', () => {
      const effect: Effect = { type: 'addVariable', variable: 'gold', value: -30 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should initialize variable if it does not exist', () => {
      const effect: Effect = { type: 'addVariable', variable: 'newVar', value: 100 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should not add to string variables', () => {
      const effect: Effect = { type: 'addVariable', variable: 'playerName', value: 10 }
  ...
  describe('addItem', () => {
    ...
    it('should not add duplicate items', () => {
      ...
      expect(newState.inventory.filter(id => id === 'rusty_key').length).toBe(1)
    })
  })
  ...
  describe('moveItem', () => {
    it('should move item to a location', () => {
      const effect: Effect = { type: 'moveItem', itemId: 'rusty_key', locationId: 'cellar' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('setQuestStage', () => {
    it('should set quest to a specific stage', () => {
      const effect: Effect = { type: 'setQuestStage', questId: 'odd_jobs', stageId: 'started' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should update existing quest stage', () => {
      const effect: Effect = { type: 'setQuestStage', questId: 'odd_jobs', stageId: 'complete' }
      const state = { ...createTestState(), questProgress: { odd_jobs: 'started' } }
      const newState = applyEffect(effect, state)
  ...
  describe('addJournalEntry', () => {
    ...
    it('should not add duplicate entries', () => {
      const effect: Effect = { type: 'addJournalEntry', entryId: 'chapter_1' }
      const state = { ...createTestState(), unlockedJournalEntries: ['chapter_1'] }
      const newState = applyEffect(effect, state)

      expect(newState.unlockedJournalEntries.filter(id => id === 'chapter_1').length).toBe(1)
    })
  })

  describe('startDialogue', () => {
    it('should start a dialogue', () => {
      const effect: Effect = { type: 'startDialogue', dialogueId: 'bartender_greeting' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('setCharacterLocation', () => {
    it('should move character to new location', () => {
      const effect: Effect = { type: 'setCharacterLocation', characterId: 'bartender', locationId: 'market' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should not affect non-existent characters', () => {
      const effect: Effect = { type: 'setCharacterLocation', characterId: 'unknown', locationId: 'market' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('removeFromParty', () => {
    it('should remove character from party', () => {
      const effect: Effect = { type: 'removeFromParty', characterId: 'pixel_the_dog' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('setRelationship', () => {
    it('should set character relationship value', () => {
      const effect: Effect = { type: 'setRelationship', characterId: 'bartender', value: 10 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('addRelationship', () => {
    it('should add to character relationship', () => {
      const effect: Effect = { type: 'addRelationship', characterId: 'bartender', value: 3 }
    ...
    it('should subtract from character relationship', () => {
      const effect: Effect = { type: 'addRelationship', characterId: 'bartender', value: -2 }
      const state = createTestState() // bartender starts at 5
      const newState = applyEffect(effect, state)
  ...
  describe('setCharacterStat', () => {
    it('should set character stat value', () => {
      const effect: Effect = { type: 'setCharacterStat', characterId: 'pixel_the_dog', stat: 'level', value: 5 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
    ...
    it('should create new stat if it does not exist', () => {
      const effect: Effect = { type: 'setCharacterStat', characterId: 'bartender', stat: 'mana', value: 100 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('addCharacterStat', () => {
    it('should add to existing numeric stat', () => {
      const effect: Effect = { type: 'addCharacterStat', characterId: 'bartender', stat: 'health', value: 20 }
    ...
    it('should subtract from existing numeric stat', () => {
      const effect: Effect = { type: 'addCharacterStat', characterId: 'pixel_the_dog', stat: 'health', value: -10 }
    ...
    it('should initialize stat if it does not exist', () => {
      const effect: Effect = { type: 'addCharacterStat', characterId: 'bartender', stat: 'mana', value: 50 }
      const state = createTestState()
      const newState = applyEffect(effect, state)
  ...
  describe('playSound', () => {
    ...
    it('should append to existing pendingSounds', () => {
      ...
      expect(newState.pendingSounds).toEqual(['door_slam.ogg', 'explosion.ogg'])
    })
  })

  describe('notify', () => {
    it('should add notification', () => {
      const effect: Effect = { type: 'notify', message: '@quest.odd_jobs.started' }
      const state = createTestState()
      const newState = applyEffect(effect, state)
